...
{
    public partial class FormActivosFijosCBUbicacion : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormActivosFijosCBUbicacion()
        {
            InitializeComponent();
        }

        private void FormActivosFijosCBUbicacion_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public override void GetData(int opcion = 0)
        {
            ...
            try
            {
                ...
                objDB.AddFiltroEmpieceEN("Tipo", "CB-UBIC");
