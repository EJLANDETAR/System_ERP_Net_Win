...
{
    public partial class FormActivosFijosCBResp : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormActivosFijosCBResp()
        {
            InitializeComponent();
        }

        private void FormActivosFijosCBResp_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public override void GetData(int opcion = 0)
        {
            ...
            try
            {
                ...
                objDB.AddFiltroEmpieceEN("Tipo", "CB-RESP");
