...
{
    public partial class FormAnularRecibo : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormAnularRecibo()
        {
            InitializeComponent();
        }
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            try
            {
                    ...
                    e.RowIndex >= 0)
                {
                    ...
                    frm.nombreCampoId = "Recibo_Id";
                    frm.drFilaSel = myFila;
                    frm.Text = this.Text;
                    frm.SP_ANULA = "SP_CAJAS_ANULA_RECIBO";
