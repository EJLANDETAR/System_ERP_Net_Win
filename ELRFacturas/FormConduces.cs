...
{
    public partial class FormConduces : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormConduces()
        {
            InitializeComponent();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int spReturn = 0;
            string temporalId = "";
            FormFacturasListR frm = new FormFacturasListR();
        ...
        {
            string info = "CONDUCE NO.: 000000,   Sub Total: 0.00  Itbis: 0.00   Descuento: 0.00  Total: 0.00";
            DataRow fila0;
            string valorUnico = "0";
            int numero = 0;
            ...
            try
            {
                if(dataGridView1.RowCount > 0)
                {
                    ...
                    info = "CONDUCE NO.: " + numero.ToString().PadLeft(6, '0') + ",";
