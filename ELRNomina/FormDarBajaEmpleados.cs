...
namespace ELRNomina
{
    public partial class FormDarBajaEmpleados : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormDarBajaEmpleados()
        {
            InitializeComponent();
        }
        ...
        private void dtgData_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            FormDarBajaEmpleadosR frm = new FormDarBajaEmpleadosR();
            try
            {
