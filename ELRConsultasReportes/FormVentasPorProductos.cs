...
{
    public partial class FormVentasPorProductos : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormVentasPorProductos()
        {
            InitializeComponent();
        }

        private void FormVentasPorProductos_Load(object sender, EventArgs e)
        {
        ...
        public override void GetData(int opcion = 0)
        {
            ...
            try
            {
                ...
                MyData = objDB.GetAll("VVENTAS_DETALLE", -1, objDB.Filtros);
        ...
        public override void Imprimir()
        {
            ...
            try
            {
                pathReporte = objUtil.GetPathReportRDLC("RptVentasPorProductos");
                ...
                frm.titulo = "VENTAS POR PRODUCTOS, FECHA [ " + objUtil.GetDateAsString(dtpFecha1.Value) + " - " + objUtil.GetDateAsString(dtpFecha2.Value) + "]";
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
