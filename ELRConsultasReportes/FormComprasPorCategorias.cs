...
{
    public partial class FormComprasPorCategorias : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormComprasPorCategorias()
        {
            InitializeComponent();
        }
        ...
        public override void Imprimir()
        {
            ...
            try
            {
                pathReporte = objUtil.GetPathReportRDLC("RptComprasPorCategorias");
                ...
                frm.titulo = "COMPRAS POR CATEGORIAS, FECHA [ " + objUtil.GetDateAsString(dtpFecha1.Value) + " - " + objUtil.GetDateAsString(dtpFecha2.Value) + "]";
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
        ...
        private void FormComprasPorCategorias_Load(object sender, EventArgs e)
        {
