...
{
    public partial class FormVentasDetallePorCliente : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormVentasDetallePorCliente()
        {
            InitializeComponent();
        }

        private void FormVentasDetallePorCliente_Load(object sender, EventArgs e)
        {
