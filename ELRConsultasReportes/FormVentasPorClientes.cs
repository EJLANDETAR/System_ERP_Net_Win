...
{
    public partial class FormVentasPorClientes : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormVentasPorClientes()
        {
            InitializeComponent();
        }

        private void FormVentasPorClientes_Load(object sender, EventArgs e)
        {
        ...
        public override void Imprimir()
        {
            ...
            try
            {
                pathReporte = objUtil.GetPathReportRDLC("RptVentasPorClientes");
                ...
                frm.titulo = "VENTAS POR CLIENTES, FECHA [ " + objUtil.GetDateAsString(dtpFecha1.Value) + " - " + objUtil.GetDateAsString(dtpFecha2.Value) + "]";
                frm.ShowDialog();
            }
            catch (Exception ex)
            {
