...
{
    public partial class FormActivosFijoVentasRetiros : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormActivosFijoVentasRetiros()
        {
            InitializeComponent();
        }
        ...
        public override void Imprimir()
        {
            ...
            try
            {
                pathReporte = objUtil.GetPathReportRDLC("RptActivosFijosVentasRetiros");
                ...
                frm.titulo = @"VENTAS Y\O RETIROS DE ACTIVOS FIJOS, FECHA [ " + objUtil.GetDateAsString(dtpFecha1.Value) + " - " + objUtil.GetDateAsString(dtpFecha2.Value) + "]";
        ...
        public override void GetData(int opcion = 0)
        {
            ...
            double totalVenta = 0, totalGanancia = 0;
            try
            {
                ...
                objDB.AddFiltroPersonalizado("(Tipo = 'VENTA' Or Tipo = 'RETIRO')");
                ...
                totalVenta = GetSum("Monto");
                totalGanancia = GetSum("Monto_Ganancia");

                lblCantidadRegistro.Text = "Total Venta: " + totalVenta.ToString("N2");
                lblCantidadRegistro.Text += "      Ganancia: " + totalGanancia.ToString("N2");
        ...
        private void FormActivosFijoVentasRetiros_Load(object sender, EventArgs e)
        {
            DateTime fecha = DateTime.Now.Date;
