...
{
    public partial class FormComprasOrdenPorProductos : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormComprasOrdenPorProductos()
        {
            InitializeComponent();
        }

        private void FormComprasOrdenPorProductos_Load(object sender, EventArgs e)
        {
