...
{
    public partial class FormActivosFijosPorFechaAdquisicion : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormActivosFijosPorFechaAdquisicion()
        {
            InitializeComponent();
        }
        ...
        public override void Imprimir()
        {
            ...
            try
            {
                pathReporte = objUtil.GetPathReportRDLC("RptActivosFijosAdicionados");
                ...
                frm.titulo = "LISTADO DE ADQUISICION DE ACTIVOS FIJOS, FECHA [ " + objUtil.GetDateAsString(dtpFecha1.Value) + " - " + objUtil.GetDateAsString(dtpFecha2.Value) + "]";
        ...
        private void FormActivosFijosPorFechaAdquisicion_Load(object sender, EventArgs e)
        {
            DateTime fecha = DateTime.Now.Date;
