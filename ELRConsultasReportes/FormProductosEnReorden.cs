...
{
    public partial class FormProductosEnReorden : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormProductosEnReorden()
        {
            InitializeComponent();
        }

        private void chkSoloInventario_CheckedChanged(object sender, EventArgs e)
        {
            GetData();
        }
        ...
        public override void GetData(int opcion = 0)
        {
            ...
            try
            {
                ...
                FiltroEstatico = "EsActivo = 1 And IsNull(EnExistencia, 0) <= IsNull(Punto_Reorden, 0) ";

                if (chkSoloInventario.Checked) FiltroEstatico += " And EsInventario = 1";
