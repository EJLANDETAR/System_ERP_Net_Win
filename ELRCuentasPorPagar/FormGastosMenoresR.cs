...
{
    public partial class FormGastosMenoresR : WinControl_ELR_NET.ELRFormRegistro
    {
        ...
        public override void TotalizarDetalle()
        {
            ...
            try
            {
                ...
                SetValorEncabezado("Monto_APagar", total);
                SetValorEncabezado("Monto_Pendiente", total);
                SetValorEncabezado("MontoNCF", total);
        ...
        private void FormGastosMenoresR_Load(object sender, EventArgs e)
        {
            //ESPECIFICAMOS QUE EL METODO IMPRIMIR ES PREVIEW
            metodoImp = 3;
        }
