...
namespace ELRBanco
{
    public partial class FormOtrasTrans : WinControl_ELR_NET.FormPlantillaIndex
    {
        public FormOtrasTrans()
        {
            InitializeComponent();
        }
        ...
        private void FormOtrasTrans_Load(object sender, EventArgs e)
        {
