...
namespace ELRBanco
{
    public partial class FormBancosChequesR : WinControl_ELR_NET.ELRFormRegistro
    {
        ...
        bool esGenerarChequeNo = false;

        public FormBancosChequesR()
        {
            InitializeComponent();
        }
        ...
        public override void TotalizarDetalle()
        {
            ...
            try
            {
                ...
                SetValorEncabezado("Monto", diferencia);
                txtMonto.Text = diferencia.ToString("N2");
            }
            catch (Exception)
            {
        ...
        public override bool GetData()
        {
            ...
            try
            {
                ...
                if (esNuevo)
                {
                    ...
                    SetValorEncabezado("Tipo", "CHK");
                    cboCuenta.SelectedValue = 0;
                }

                dtpFecha.Enabled = EsCambiarFecha;

                valorVariable = objDB.GetValorVariable("GENERAR_CHEQUE_NUMERO");
                esGenerarChequeNo = (valorVariable == "1" || valorVariable == "TRUE");
        ...
        public override void AgregarLineaVacia()
        {
            ...
            try
            {
                ...
                if (DRCuentasContables != null)
                {
                    ...
                    DataGridDetalle.CurrentCell = DataGridDetalle["Debito", index];
        ...
        private void FormBancosChequesR_Load(object sender, EventArgs e)
        {
            try
            {
                if (EnEjecusion)
